...
/**
 * Server socket factory creating managed socket bindings.
 * 
 * This factory ignores port and inetAddress arguments, since come from 
 * the domain model. TODO check if that makes sense!
 * 
