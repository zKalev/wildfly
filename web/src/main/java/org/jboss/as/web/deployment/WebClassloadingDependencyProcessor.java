...
public class WebClassloadingDependencyProcessor implements DeploymentUnitProcessor {
    ...
    private static final ModuleIdentifier JAVAX_SERVLET_API = new ModuleIdentifier("javax.servlet", "api", null);
    private static final ModuleIdentifier JAVAX_SERVLET_JSP_API = new ModuleIdentifier("javax.servlet.jsp", "api", null);
    private static final ModuleIdentifier JBOSS_WEB = new ModuleIdentifier("org.jboss.as", "jboss-as-web", null);
    ...
    public void processDeployment(DeploymentUnitContext context) throws DeploymentUnitProcessingException {
        ...
        // FIXME we need to revise the exports of the web module, so that we don't export our internals
