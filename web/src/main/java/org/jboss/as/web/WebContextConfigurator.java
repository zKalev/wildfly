...
/**
 * Internal helper for common context configurations. Sort of a replacement for
 * the shared web.xml, aggregating common configuration and operations from the
 * domain model.
 *
